...
<div
  ...
  onclick={openModal}
  style="position:fixed; bottom:0; right:0; width:40vw; height:40vh; z-index:30; cursor:pointer; pointer-events:auto;"
...
{#if showModal}
  <div bind:this={modalRef} class="feature-modal bottom-right-modal" style="position:fixed; top:0; left:0; right:0; bottom:0; z-index:60; background:rgba(20,16,40,0.97); display:flex; flex-direction:column; pointer-events:auto;" role="dialog" aria-modal="true">
